		...
		<div class="row">
		 ...
		 <div class="col-md-8">
			...
			<blockquote class="pull-right">
				<p>Le bonheur est contagieux : entourez-vous de visages heureux.</p>
				<small>Dominique Glocheux</small>
			</blockquote>
			...
			-->
				...
				<h3>L'histoire</h3>
					...
					<p>
						Nous avons besoin de vous pour accélérer ces projets open-source ! N’hésitez pas à <a href="https://github.com/bronycub/" target="_blank">proposer votre aide ! <i class="fa fa-github-square"></i></a>
					</p>
					...
					<h3>Les Outils</h3>
						...
						<ul class="nav nav-tabs">
							...
							<li class=""><a href="#gravatar" data-toggle="tab" aria-expanded="false">Gravatar</a></li>
							<li class=""><a href="#plugdj" data-toggle="tab" aria-expanded="false">Plug.DJ</a></li>
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade active in" id="mailinglist">
							<p>
								La ML (mailing list ou liste de diffusion en Français) <strong>bronycub@googlegroups.com</strong> à laquelle vous serez bientôt ajouté permet de communiquer les informations importantes lié a la vie du collectif. C'est notre 1er moyen de communication !
							</p>
							<p>
								Elle permet de s’organiser et de se tenir au courant de tout les évènements fait par le collectif et surtout de contacter le collectif directement dans son intégralité.<br />
							...
							<p>
								Il est important de mettre en place un filtre dans votre boite e-mail avec le mot clef <em>[BronyCUB]</em> pour gérer efficacement le flux de message (environ un millier par an).<br />
						...
						<div class="tab-pane fade" id="agenda">
							...
							<div class="alert alert-dismissible alert-warning">
								...
								Vous ne vous en sentez pas capable ? C'est donc l'occasion parfaite de gagner confiance en vous, vous aurrez beaucoup soutient ici.
							</div>
						</div>
						...
						<div class="tab-pane fade" id="carte">
							...
							<p>
								Nos amis du site d’information <a href="http://leponeyblanc.fr" target="_blank">Le Poney Blanc</a>, disposent également d’une carte similaire, à l'échelle de la France entière : <a href="http://carte.leponeyblanc.fr" target="_blank">carte.leponeyblanc.fr</a>
								</p>
						</div>

						<div class="tab-pane fade" id="gravatar">
							<p>
								<a href="http://fr.gravatar.com/" target="_blank">Gravatar</a>, est un service permettant d’associer a votre pseudo une image sur de nombreux sites. C’est grâce a lui que l’on gère les avatars actuellement. Créez votre <a href="http://fr.gravatar.com/" target="_blank">Gravatar</a> en utilisant la même adresse e-mail indiqué pendant votre inscription sur BronyCUB et celle-ci apparaîtra automatiquement sur votre fiche membre.
							</p>
							<p>
								Si vous rencontrez des difficultés avec ce service, consultez notre <a data-toggle="modal" data-target="#modal_gravatar">procédure d’aide Gravatar</a>.
							</p>

								<!-- procedure gravatar -->
								<div class="modal fade" id="modal_gravatar" tabindex="-1" role="dialog" aria-labelledby="procedure" aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
												<h4 class="modal-title" id="procedure">Procédure d'inscription Gravatar</h4>
											</div>
											<div class="modal-body">
												<ol>
													<li>Sur le site <a href="http://fr.gravatar.com/" target="_blank">gravatar.com</a>, allez en haut à droite pour vous inscrire <a href="http://i.imgur.com/5tJbVZX.jpg" target="_blank"><i class="fa fa-picture-o"></i></a></li>
													<li>Une fois sur la page pour se connecter, cliquez en dessous pour s'inscrire <a href="http://i.imgur.com/Nh2xN1L.jpg" target="_blank"><i class="fa fa-picture-o"></i></a></li>
													<li>Suivez la procédure d'inscription classique (activation du compte, connexion.....)</li>
													<li>Une fois sur votre profil (quand on se connecte) il devrait y avoir déjà votre adresse mail d'enregistrée avec l'image gravatar par défaut, si ce n'est pas le cas cliquez sur "ajouter une nouvelle adresse" pour en rajouter une <a href="http://i.imgur.com/sJjzALm.jpg" target="_blank"><i class="fa fa-picture-o"></i></a></li>
													<li>Une fois que vous avez enregistré votre adresse il vous faut une image! Du coup on fait pareil en dessous <a href="http://i.imgur.com/BvZEwPy.jpg" target="_blank"><i class="fa fa-picture-o"></i></a></li>
													<li>Une fois dans le menu d'image on choisit comment on veut l'uploader, à partir du pc, directement en ligne...</li>
													<li>Quand l'image est choisie il nous permet de la recadrer <a href="http://i.imgur.com/O3GpUil.jpg" target="_blank"><i class="fa fa-picture-o"></i></a></li>
													<li>Une fois l'image bien recadrée on peut valider</li>
													<li>Il nous demande enfin si l'image est "Safe For Work" (que ce n'est pas une image pornographique par exemple) pour choisir il faut cliquer sur une des 4 images en dessous de la nôtre <a href="http://i.imgur.com/2k4j66W.jpg" target="_blank"><i class="fa fa-picture-o"></i></a> les explications sur ce que chacune veut dire sont juste en dessous</li>
													<li>Quand c'est choisi on assigne à quelle adresse on veut mettre l'image <a href="http://i.imgur.com/wJAM3uJ.jpg" target="_blank"><i class="fa fa-picture-o"></i></a></li>
												</ol>
											</div>
							...
							<div class="tab-pane fade" id="plugdj">
								<p>
