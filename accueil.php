		...
		<div class="row">
		 ...
		 <div class="col-md-8">
			...
			<h3>Localisation</h3>
				...
				<p>
					BronyCUB étant un collectif, nous ne disposons pas de locaux. Mais nous avons tout de même un "Quartier Général" où nous nous retrouvons régulièrement : <a href="qg.php" target="_blank">le Calice du Dragon</a>.
					<br />
			...
			-->
				...
				<h3>L'histoire</h3>
					...
					<p>
						Malgré tout, la V2 a encore besoin de beaucoup d'améliorations et c’est pour cela que l’un des projets actuels de BronyCUB est la création de la nouvelle version du site : <a href="https://github.com/bronycub/sugarcub" target="_blank">SugarCUB</a> !
						<br />
					...
					<div id="myTabContent" class="tab-content">
						...
						<div class="tab-pane fade" id="gravatar">
							<p>
								<a href="http://fr.gravatar.com/" target="_blank">Gravatar</a>, est un service permettant d’associer à votre pseudo une image sur de nombreux sites. C’est grâce à lui que l’on gère les avatars actuellement. Créez votre <a href="http://fr.gravatar.com/" target="_blank">Gravatar</a> en utilisant la même adresse e-mail indiquée pendant votre inscription sur BronyCUB et celle-ci apparaîtra automatiquement sur votre fiche membre.
							</p>
							<p>
