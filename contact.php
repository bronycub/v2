      ...
      <div class="tab-pane fade" id="irc">
        ...
        <div class="container">
          ...
          <div class="col-lg-4">
            ...
            <ul class="breadcrumb"><li style=""><i class="fa fa-link fa-1x"></i> <a href="https://kiwiirc.com/client?settings=3ebf3eb7a40c2b03f47b918eb2f7087a"><strong>chat.freenode.net</strong></a> (via kiwiirc.com)</li></ul>
          </div>
          <div class="col-lg-4"></div>
        </div>
        <p>
