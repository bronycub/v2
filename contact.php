      ...
      <div class="tab-pane fade" id="irc">
        ...
        <p>
          Salon de conversation libre. Ce Tchat permet aux membres de BronyCUB ou autre de venir discuter de manière pratique et simple.<br />
				...
				<ul>
					<li>#bronycub, le canal 'principal'</li>
					<li>#bronycub-g33k, le canal geek/info/etc (tapez <code>/join #bronycub-g33k</code> pour y aller)</li>
        ...
        <div class="alert alert-dismissible alert-info">
          <p>
						Les règles suivantes sont à respecter:
							<ul>
								<li>Le canal #bronycub est pour TOUS et TOUTES, il est donc proscrit d'y envoyer des liens dits 'NSFW' (porno, etc), pensez aux plus jeunes (et aux parents…)</li>
								...
								CEPENDANT, pour les plus curieux vous aurez certainement remarqué que Discord est un chat PROPRIÉTAIRE, et donc soyez conscients que lorsque vous discutez sur #bronycub ou #bronycub-g33k, vous parlez à tout le monde,
        ...
        <div class="alert alert-dismissible alert-info">
					...
					<ul>
						...
						<li><strong>Canal de discussion&nbsp;:</strong> <code>#bronycub</code>, <code>#bronycub-g33k</code> et <code>#bronycub-void</code></li>
					</ul>
        </div>
